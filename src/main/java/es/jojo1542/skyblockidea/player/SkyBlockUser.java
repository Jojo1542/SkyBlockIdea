...
import es.jojo1542.skyblockidea.player.profile.type.SingleSkyBlockProfile;
...
public class SkyBlockUser {
    ...
    //Guardas una lista de las ID de sus perfiles
    ...
    public SingleSkyBlockProfile getActualProfile() {
